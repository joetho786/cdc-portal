...
from .models import News, PastRecruiters, Volunteers, AlumniTestimonial, HomeImageCarousel, DesignationChoices, VolunteersYearChoices, CareerCommittee, CoreTeamContacts, NavBarSubOptions, NavBarOptions, DesignationChoices
